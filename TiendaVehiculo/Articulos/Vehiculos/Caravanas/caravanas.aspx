<%@ Page Title="" Language="C#" MasterPageFile="~/Articulos/Vehiculos/vehiculosM.master" AutoEventWireup="true" CodeBehind="caravanas.aspx.cs" Inherits="TiendaVehiculo.Articulos.Vehiculos.Caravanas.caravanas1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="foldermedio" runat="server">
    <h2 style="margin-bottom: 6px">Listado de Caravanas Carmander</h2>
        ...
        <div id="cuadricula">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [nombre], [descripcion], [pvp], [url_imagen], [disponible] FROM [VEHICULO] WHERE ([tipo] = @tipo)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="CARAVANA" Name="tipo" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
