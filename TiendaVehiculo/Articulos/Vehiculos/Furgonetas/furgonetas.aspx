<%@ Page Title="" Language="C#" MasterPageFile="~/Articulos/Vehiculos/vehiculosM.master" AutoEventWireup="true" CodeBehind="furgonetas.aspx.cs" Inherits="TiendaVehiculo.Articulos.Vehiculos.camiones.furgonetas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="foldermedio" runat="server">
    <h2 style="margin-bottom: 6px">Listado de Furgonetas Carmander</h2>
