<%@ Page Title="" Language="C#" MasterPageFile="~/Articulos/Vehiculos/vehiculosM.master" AutoEventWireup="true" CodeBehind="motos.aspx.cs" Inherits="TiendaVehiculo.Articulos.Vehiculos.Motos.motos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="foldermedio" runat="server">
    <h2>&nbsp;Listado de Motos Carmander</h2>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [nombre], [descripcion], [pvp], [url_imagen], [disponible] FROM [VEHICULO] WHERE ([tipo] = @tipo)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="MOTO" Name="tipo" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
