     ...
     <div id="identicar">
               ...
               <div id="carrito">
                ...
                <div id="iconocarrito">
                    ...
                    <img src="/imagenes/carrito.png" style="height: auto; width: 35%; margin-left: 55%;margin-top:-40%"/></a>
                </div>
                <div id="buscador">
                    <asp:TextBox ID="TextBox1" placeholder="Busca en la tienda" runat="server" Width="60%" style="margin-left: 8%"></asp:TextBox>
                    <asp:Button ID="Button1" runat="server" Text="🔎" Width="18%" style="margin-left: 2%"/>
                </div>
</asp:Content>
