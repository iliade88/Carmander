...
<asp:Content ID="Content1" ContentPlaceHolderID="medio" runat="server">
    ...
    <asp:TextBox ID="Apellido1" runat="server" placeholder="Primer apellido"></asp:TextBox>
    ...
    <asp:TextBox ID="day" runat="server" placeholder=" DD/MM/AAAA"></asp:TextBox>
    </div>
    ...
    <div id="aceptar">
        <asp:Button ID="aceptado" runat="server" class="button" Text="Registro" />
